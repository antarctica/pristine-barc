...
to bring up a local testing environment
2. `$ cd £PROJECT-LOWER-CASE/tests/provisioning/site-testing-local`
3. `$ vagrant up`
4. `$ cd ..`
...
1. `$ cd £PROJECT-LOWER-CASE/tests/provisioning`
...
Results for these tests can be found [here](£CONTINUOS-INTEGRATION-ROLE-URL).
